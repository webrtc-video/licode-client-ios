...
- (void)loadView {
  ...
  self.view = _videoCallView;
    ...
    /*if(_localVideoTrack!=nil)
        [_localVideoTrack addRenderer:_videoCallView.localVideoView];*/  //add by lihengz
}
...
- (void)setLocalVideoTrack:(RTCVideoTrack *)localVideoTrack {
  ...
  //_videoCallView.localVideoView.captureSession = source.captureSession; //del by lihengz
  [_localVideoTrack addRenderer:_videoCallView.localVideoView];  //add by lihengz
}
