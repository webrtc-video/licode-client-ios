...
- (instancetype)initWithFrame:(CGRect)frame {
  if (self = [super initWithFrame:frame]) {
    ...
    _localVideoView = [[/*RTCCameraPreviewView*/RTCEAGLVideoView alloc] initWithFrame:CGRectZero]; //modify by lihengz
...
- (void)layoutSubviews {
  ...
  if (_remoteVideoSize.width > 0 && _remoteVideoSize.height > 0) {
    ...
    remoteVideoFrame.size.width *= scale;
      //_remoteVideoView.transform = CGAffineTransformMakeScale(-1.0, 1.0); //lihengz
