...
- (void) sendEvent:(NSString *)eventName withData:(id)data withOption:(id)option andAcknowledge:(SocketIOCallback)function
{
    NSMutableDictionary *dict = [NSMutableDictionary dictionaryWithObject:eventName forKey:@"name"];
    ...
    if (data != nil) {
        if(option !=nil)
            [dict setObject:[NSArray arrayWithObjects:data,option,nil] forKey:@"args"];
        else
            [dict setObject:[NSArray arrayWithObjects:data,nil] forKey:@"args"];
    }
